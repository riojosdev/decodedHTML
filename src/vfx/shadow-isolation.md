...
Working with shadows is a tough job. It seems really cool to have shadows on your composition. And in the case for video capturing, the raw footage, when it have shadows the overlay on your subject or environment, it means the assets you are going to integrate later, would also need to follow the same shadow rules. Shadow follows the lighting, I'm not talking much about lighting because shadow is a pain in my a**. Lighting doesn't make me notice much. 
...
<img src="../images/chroma-keying-matte-refinement-separation-of-character-and-shadow.png" id="meta_imgz">
